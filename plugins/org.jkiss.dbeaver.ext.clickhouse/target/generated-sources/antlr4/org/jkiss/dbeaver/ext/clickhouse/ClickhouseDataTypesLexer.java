...
public class ClickhouseDataTypesLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "Enum", "Map", 
			"Array", "Tuple", "Int", "Float", "Decimal", "RightParen", "LeftParen", 
			"Space", "Number", "Identifier", "Comma", "Eq", "String"
		};
	}
	...
	public ClickhouseDataTypesLexer(CharStream input) {
		super(input);
